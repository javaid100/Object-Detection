# ============= Object Detection in Images using Tensorflow Object Detection API ================
...
def load_image_into_numpy_array(image):
    ...
    return np.array(image.getdata()).reshape((im_height, im_width, 3)).astype(np.int64)


# Detection
# For the sake of simplicity we will test on 3 mages.
TEST_IMAGE_PATHS = ["E:\SOFTWARES\Object Detection\image1.jpg", "E:\SOFTWARES\Object Detection\image2.jpg", 
                    "E:\SOFTWARES\Object Detection\image3.jpg"]
...
for image_path in TEST_IMAGE_PATHS:
    ...
    plt.imshow(image_np)
    plt.savefig("Image_{}.png".format(TEST_IMAGE_PATHS.index(image_path)+1))
